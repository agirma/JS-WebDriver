...
var QUnit = {
	...
	greaterThanOrEqual: function (actual, expected, message) {
		push(actual >= expected, actual, expected, message);
	},
	...
	within: function (actual, expected, message, difference) {
		push(Math.abs(expected - actual) <= difference, actual, expected, message);
	},
